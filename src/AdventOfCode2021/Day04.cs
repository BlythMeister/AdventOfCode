...
namespace AdventOfCode2021
{
    ...
    public class Day04
    {
        private readonly string[] realData = File.ReadAllLines(Path.Combine(TestContext.CurrentContext.TestDirectory, "Data", "Day04.dat"));

        [TestCase("Day04-Sample.dat", 4512)]
        [TestCase(null, 31424)]
        ...
        [TestCase("Day04-Sample.dat", 1924)]
        [TestCase(null, 23042)]
